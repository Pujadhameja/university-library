...
function AuthLayout({
  ...
  return (
    <main className="flex flex-row min-h-screen text-light-200">
      <section className="bg-gradient-horizontal w-1/2 max-sm:w-full justify-center items-center flex">
      ...
      <section className="bg-auth-user bg-cover bg-center bg-no-repeat w-1/2 max-sm:hidden"></section>
    </main>
  );
}
